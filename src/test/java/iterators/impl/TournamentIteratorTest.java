...
class TournamentIteratorTest {
    ...
    void next(List<Player> players, int numberOfIterations, boolean expectedNext, boolean expectedWinner, Player winner) throws WrongNumberOfPlayersError {
        ...
        if (expectedWinner)
            assertEquals(winner, iterator.winner().get());
    }
}